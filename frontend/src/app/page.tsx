...
export default function Home() {
  return (
    <div className="grid grid-rows-[10px_2fr_10px] items-center justify-items-center min-h-screen p-1 pb-1 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
